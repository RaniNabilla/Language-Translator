document.addEventListener("DOMContentLoaded", function () {
  ...
  // Objek JavaScript ini adalah kamus atau pemetaan, di mana setiap pasangan kunci-nilai
  // mewakili kode bahasa dan nama bahasa yang sesuai.
  const countries = {
    "am-ET": "Amharic",
    "ar-SA": "Arabic",
    // ... (daftar bahasa yang lain)
    "zu-ZA": "Zulu",
  };
  ...
  selectTags.forEach((tag, id) => {
    for (let country_code in countries) {
      ...
      let selected =
        id == 0 ? (country_code == "en-GB" ? "selected" : "") : (country_code == "bn-IN" ? "selected" : "");
